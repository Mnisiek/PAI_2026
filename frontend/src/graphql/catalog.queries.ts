...
import getPopularProducts from './catalog/getPopularProducts.graphql?raw'
...
import getAdminProducts from './catalog/getAdminProducts.graphql?raw'
...
export const GET_POPULAR_PRODUCTS = gql(getPopularProducts)
...
export const GET_ADMIN_PRODUCTS = gql(getAdminProducts)
