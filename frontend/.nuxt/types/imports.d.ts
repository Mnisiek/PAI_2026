...
declare global {
  ...
  const useCartStore: typeof import('../../src/stores/cart.store').useCartStore
  const useCatalogStore: typeof import('../../src/stores/catalog.store').useCatalogStore
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useCartStore: UnwrapRef<typeof import('../../src/stores/cart.store')['useCartStore']>
    readonly useCatalogStore: UnwrapRef<typeof import('../../src/stores/catalog.store')['useCatalogStore']>
